...
sql_uri = "mysql://%s:%s@%s:%s/%s?charset=utf8" % ('root', 'OO00zZOK', '127.0.0.1', '33066', 'yurburo')
...
for one in resp:
    ...
    word_list = [s for s in data_helpers_conparser.clean_str_new(text).split(' ')]
...
model.save('./data/yurburo_word2vec_model_dim300_new_data_helper_w7_i10')
...
model.save('./data/yurburo_word2vec_model_dim400_new_data_helper_w7_i10')
...
model.save('./data/yurburo_word2vec_model_dim500_new_data_helper_w7_i10')
